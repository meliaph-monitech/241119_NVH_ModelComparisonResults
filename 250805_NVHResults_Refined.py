...
def load_and_plot_csv_with_highlights(file, summary_df, selected_model):
    ...
    # Plot bead highlights based on selected model predictions
    ...
    fig.update_layout(
        title=f"Bead-Level NVH Data Visualization ({selected_model})",
        xaxis_title="Index",
...
if uploaded_zip:
    ...
    if csv_files:
        ...
        # Bring back ML model selection (Prediction columns only)
        ...
        # Auto-plot when file or model changes
